...
function Footer({t}) {
  ...
  return (
    <footer className={styles.footer}>
      <img src={p('/static/icons/icon_phone.svg')} alt="phone_icon" width={15} height={15} style={{alignSelf:"center"}}/>
      <p>+34 623 17 29 68 || +34 617 24 00 23 </p>
      <img src={p('/static/icons/icon_mail.svg')} alt="icon_mail" width={15} height={15} style={{alignSelf:"center"}}/>
      {isCopied ?
